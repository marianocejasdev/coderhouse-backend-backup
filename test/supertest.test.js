...
describe("Pruebas con supertest", () => {
    ...
    const user = {
        first_name: "Mariano",
        last_name: "Cejas",
        email: "zeikdev2@gmail.com",
        password: "admin"
    }

    const product = {
        title: "Grand Triple Test",
    ...
    before(async function () {
        await mongoose.connect("mongodb+srv://zeikdev:86XJH1rX12Dmx1ow@coderhouse-backend.f0hb9nc.mongodb.net/?retryWrites=true&w=majority");
    ...
    describe("Pruebas para carts", () => { // GET Add product Delete product
        ...
        it('3. PUT /api/carts/:cid', async () => { // Por motivos de comodidad del test, se modifica el producto desde aca directo a la DB y no en una petición del servidor
            await productsModel.updateOne({ _id: pid }, { $set: { owner: "otroUser@gmail.com" } });
